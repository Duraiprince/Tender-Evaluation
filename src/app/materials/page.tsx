        ...
        <div className="w-full max-w-3xl">
          <div className="mb-8 text-center">
            ...
            <p className="text-sm text-gray-500 mt-1">
              Upload documents and run AI-powered technical evaluation
            </p>
          </div>
          ...
          <div className="flex justify-center">
            <button
              ...
              className="inline-flex items-center gap-2 bg-gray-900 hover:bg-gray-800 text-white text-sm font-semibold rounded-lg px-8 py-3.5 transition-colors active:scale-[0.98] shadow-sm"
            >
